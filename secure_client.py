...
class UpdaterApp:
    def __init__(self, root):
        ...
        # Ask for user name
        self.client_name = simpledialog.askstring("Enter Name", "Please enter your name:")
        if not self.client_name:
            self.client_name = "Anonymous"  # Default name if none entered

        # Title
        tk.Label(root, text="🔄 App Updater", font=("Arial", 14, "bold")).pack(pady=10)

        # Status Label
        self.status_label = tk.Label(root, text=f"Checking for updates...\nUser: {self.client_name}", font=("Arial", 10))
    ...
    def check_for_update(self):
        ...
        try:
            ...
            if latest_version > local_version:
                ...
                self.status_label.config(text=f"✅ You have the latest version\nUser: {self.client_name}")
